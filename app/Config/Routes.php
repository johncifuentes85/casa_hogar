...
$routes->get('/productos/registros', 'Productos::index');
$routes->get('/animales/registros', 'Animales::index');
$routes->post('/productos/registros/nuevo', 'Productos::registrar');
...
$routes->get('/animales/listadotipo/(:num)', 'Animales::buscarTipo/$1');
